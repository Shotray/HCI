...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label_5.setGeometry(QtCore.QRect(60, 380, 201, 111))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        ...
        self.mes_box = QtWidgets.QMessageBox()
        self.mes_box.setWindowTitle("warning")
        self.mes_box.setIcon(QtWidgets.QMessageBox.Warning)
        self.mes_box.setStandardButtons(QtWidgets.QMessageBox.Cancel)
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        self.mes_box.setFont(font)
        self.mes_box.setStyleSheet("color: rgb(0, 117, 210);")

        self.label = QtWidgets.QLabel(self.centralwidget)
        self.label.setGeometry(QtCore.QRect(70, 160, 200, 41))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
        ...
        self.label_4.setGeometry(QtCore.QRect(60, 330, 201, 81))
        font = QtGui.QFont()
        font.setFamily("Calibri")
        font.setPointSize(14)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_5.setText(_translate("MainWindow", "3. Draw some pics by saying \"Open Canvas\""))
